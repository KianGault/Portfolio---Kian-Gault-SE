...
Without meaningful names the object in itself isn't meaningful. It can also be confusing to any external developer as they 
...
The above example demonstrates that my code followed this clean code rule as i have two short methods that both handle two 
...
## Clean Code Rule #4/5 - Keep it simple (KISS)/Single Responsibility Principle (SOLID)
This clean code rule which is called KISS (Keep it simple stupid) is the practice of keeping code as simple as possible. 
This means you don't have code that is not needed, and everything is structured in the simplest format. This practice should 
allow you to understand the code you've written without having to refer to comments post launch of the software. 

The second clean code rule this also follows is the single responsibility rule. This rule is that all methods/functions in a class
...
(create, read, update and delete) and the ability to access the SQLite database. This is all this class should do because it is
